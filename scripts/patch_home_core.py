...
patch('index.html', [
    ...
    ('Trabalho desde o levantamento do processo e das regras de negócio até arquitetura, desenvolvimento, implantação, treinamento, monitoramento e sustentação. Minha base principal é n8n self-hosted, Python, APIs REST, bancos de dados e IA generativa com revisão humana.', 'Atuo desde a conversa com usuários e stakeholders, mapeamento com BPMN e AS-IS/TO-BE e regras de negócio até arquitetura, desenvolvimento, testes, implantação, treinamento, monitoramento e sustentação. Minha base é n8n self-hosted, Python, FastAPI, APIs REST, bancos de dados, Docker e IA aplicada com revisão humana; Power Automate, Make/Zapier e CRM entram conforme o contexto.'),
    ('<div><dt>Prática</dt><dd>n8n · Python · APIs REST · SQL · Docker · IA generativa</dd></div><div><dt>Forma de trabalho</dt><dd>Revisão humana, regras claras, histórico e melhoria contínua</dd></div>', '<div><dt>Núcleo técnico</dt><dd>n8n · Python · APIs REST · PostgreSQL · Docker · IA aplicada</dd></div><div><dt>Forma de trabalho</dt><dd>BPMN/AS-IS/TO-BE · requisitos · rastreabilidade · revisão humana</dd></div>'),
    ...
    ('<div><dt>IA aplicada</dt><dd>Postagem Redes · StudioCad · Vesper Manutenção · Hubora</dd></div>', '<div><dt>IA aplicada e agentes</dt><dd>RAG/grounding · LangChain · MCP · LangGraph · CrewAI · revisão humana</dd></div>'),
...
patch('en/index.html', [
    ...
    ('I work from process discovery and business rules through architecture, development, deployment, training, monitoring and support. My main stack includes self-hosted n8n, Python, REST APIs, databases and generative AI with human review.', 'I work from stakeholder conversations, BPMN and AS-IS/TO-BE mapping and business rules through architecture, development, testing, deployment, training, monitoring and support. My core stack includes self-hosted n8n, Python, FastAPI, REST APIs, databases, Docker and applied AI with human review; Power Automate, Make/Zapier and CRM are used when the context fits.'),
    ('<div><dt>Practice</dt><dd>n8n · Python · REST APIs · SQL · Docker · Generative AI</dd></div><div><dt>Working style</dt><dd>Human review, clear rules, traceable history and continuous improvement</dd></div>', '<div><dt>Core practice</dt><dd>n8n · Python · REST APIs · PostgreSQL · Docker · Applied AI</dd></div><div><dt>Working style</dt><dd>BPMN/AS-IS/TO-BE · requirements · traceability · human review</dd></div>'),
