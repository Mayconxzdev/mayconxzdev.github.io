...
def styles():
    ...
    return {
        ...
        'section': ParagraphStyle('section', parent=base['Normal'], fontName='Helvetica-Bold', fontSize=10.2, leading=11.8, textColor=BLACK, spaceBefore=2.55 * mm, spaceAfter=1.45 * mm),
