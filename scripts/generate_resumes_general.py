...
# Recruiter contact routes remain both ATS-visible and clickable.
CONTACT_PT = (
    'Rio de Janeiro - RJ · '
...
def build(lang='pt'):
    ...
    if lang == 'pt':
        ...
        sections = {
            ...
            'edu':'FORMAÇÃO',
            'courses':'CREDENCIAIS SELECIONADAS',
            'lang':'IDIOMAS',
        }
        summary = (
        ...
        skills = [
            '<b>Automação, integrações e backend:</b> n8n self-hosted · low-code/no-code · Python · FastAPI · APIs REST · JSON · webhooks · OAuth 2.0 · SQL · PostgreSQL · Docker · contexto: Power Apps · Power Automate · Make · Zapier',
            ...
            '<b>IA aplicada e engenharia:</b> IA generativa/LLMs · APIs de LLM · agentes de IA · RAG/grounding · LangChain · human-in-the-loop · evals · JavaScript/TypeScript · Git/GitHub Actions · CI/CD · logs · monitoramento/observabilidade · tratamento de erros · retries · idempotência · segurança de integrações/segredos',
        ]
        ...
        compass_bullets = [
            'Construí pipeline em Python/SQL/Docker/AWS: CSV/TMDB API → S3 → Lambda/boto3 → Glue/PySpark → Parquet Raw/Trusted/Refined → Athena → QuickSight; pratiquei Linux, Git, ETL/Data Lake e modelagem.'
        ]
        projects = [
            ...
            '<b>Catálogo Operacional:</b> FastAPI + SQLite FTS5; 24 categorias, 480+ códigos, controle de revisão, histórico/backups e uso diário por 3 pessoas.',
        ...
        edu = [
            '<b>Análise e Desenvolvimento de Sistemas — UNISUAM</b> · conclusão prevista dez. 2026',
            '<b>Piscine 42 Rio</b> · programa intensivo em Linux/C · concluído jul. 2025',
        ]
        courses = [
            '<b>Microsoft Applied Skills (3):</b> Foundry Agents · MCP Tools with Agents · Canvas Apps with Power Apps; '
        ...
        skills = [
            '<b>Automation, integrations & backend:</b> self-hosted n8n · low-code/no-code · Python · FastAPI · REST APIs · JSON · webhooks · OAuth 2.0 · SQL · PostgreSQL · Docker · contextual exposure: Power Apps · Power Automate · Make · Zapier',
            ...
            '<b>Applied AI & engineering:</b> generative AI/LLMs · LLM APIs · AI agents · RAG/grounding · LangChain · human-in-the-loop · evals · JavaScript/TypeScript · Git/GitHub Actions · CI/CD · logs · monitoring/observability · error handling · retries · idempotency · integration/secret security',
        ]
        ...
        compass_bullets = [
            'Built a Python/SQL/Docker/AWS pipeline: CSV/TMDB API → S3 → Lambda/boto3 → Glue/PySpark → Raw/Trusted/Refined Parquet → Athena → QuickSight; practiced Linux, Git, ETL/Data Lake and data modeling.'
        ]
        projects = [
            '<b>Direct Mail:</b> 6 campaigns over a 1,020-contact base, one with 900+ recipients; 2 n8n workflows with queues, deduplication, revalidated cancellation, retry and auditing.',
            ...
            '<b>Operational Catalog:</b> FastAPI + SQLite FTS5; 24 categories, 480+ codes, revision control, history/backups and daily use by 3 people.',
            '<b>Social Publishing:</b> n8n + Meta Graph API + RAG/LangChain + human-in-the-loop + evals; Facebook/Instagram exercised in testing, with idempotency and per-channel failure isolation.',
        ]
        edu = [
            '<b>Systems Analysis and Development — UNISUAM</b> · expected Dec. 2026',
