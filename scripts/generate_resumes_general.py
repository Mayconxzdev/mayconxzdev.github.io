...
def styles():
    ...
    return {
        ...
        'section': ParagraphStyle('section', parent=base['Normal'], fontName='Helvetica-Bold', fontSize=9.6, leading=11.2, textColor=BLACK, spaceBefore=3.0*mm, spaceAfter=1.45*mm),
        'body': ParagraphStyle('body', parent=base['Normal'], fontName='Helvetica', fontSize=9.35, leading=11.7, textColor=BLACK, spaceAfter=1.35*mm),
        'small': ParagraphStyle('small', parent=base['Normal'], fontName='Helvetica', fontSize=9.0, leading=11.55, textColor=BLACK, spaceAfter=1.0*mm),
        'role': ParagraphStyle('role', parent=base['Normal'], fontName='Helvetica-Bold', fontSize=9.35, leading=11.55, textColor=BLACK, spaceAfter=0.75*mm),
        'meta': ParagraphStyle('meta', parent=base['Normal'], fontName='Helvetica', fontSize=8.35, leading=10.35, textColor=GRAY, spaceAfter=1.0*mm),
    }
