...
REPLACEMENTS = {
    ROOT / "index.html": {
        '<link rel="stylesheet" href="css/styles.css?v=e8e194c">':
        ...
        '<p class="eyebrow">REGISTRO DE SISTEMAS EM OPERAÇÃO · 2026</p>':
            '<p class="eyebrow">AUTOMAÇÃO · IA · INTEGRAÇÕES · 2026</p><span class="sr-only">ANALISTA DE AUTOMAÇÃO, IA E INTEGRAÇÕES · 2026</span>',
