...
PT_JOURNEY = '''<section class="journey">
      ...
      <div class="journey-grid"><div class="journey-facts"><p>Tecnólogo em Análise e Desenvolvimento de Sistemas · UNISUAM · conclusão prevista dez. 2026</p><p>Piscine 42 Rio · programa intensivo concluído em jul. 2025</p><p>Inglês básico · leitura independente de documentação técnica</p><p><a class="text-link" href="/competencias/credenciais/">Ver inventário e critérios de credenciais ↗</a></p></div><ol class="cert-list"><li><strong>Microsoft Applied Skills — Agents & MCP</strong><span>2 credenciais · avaliação prática em laboratório</span></li><li><strong>Microsoft Applied Skills — Power Apps</strong><span>1 credencial · Canvas Apps</span></li><li><strong>n8n Academy — N8N102 + N8N103</strong><span>APIs · connected workflows · AI · testing · best practices</span></li><li><strong>Make Academy — AI Agent Builder</strong><span>MCP · segurança · context engineering · assessment</span></li><li><strong>UiPath Academy — Automation Business Analyst Associate Training</strong><span>process discovery · BPMN · UAT · implantação</span></li><li><strong>FIRJAN SENAI — Agentes e Automações</strong><span>40h</span></li></ol></div>
    </section>'''
...
EN_JOURNEY = '''<section class="journey">
      ...
      <div class="journey-grid"><div class="journey-facts"><p>Technology Degree in Systems Analysis and Development · UNISUAM · expected Dec. 2026</p><p>42 Rio Piscine · intensive program completed Jul. 2025</p><p>Basic English · independently reads technical documentation</p><p><a class="text-link" href="/en/credentials/">View credential inventory and criteria ↗</a></p></div><ol class="cert-list"><li><strong>Microsoft Applied Skills — Agents & MCP</strong><span>2 credentials · hands-on lab assessment</span></li><li><strong>Microsoft Applied Skills — Power Apps</strong><span>1 credential · Canvas Apps</span></li><li><strong>n8n Academy — N8N102 + N8N103</strong><span>APIs · connected workflows · AI · testing · best practices</span></li><li><strong>Make Academy — AI Agent Builder</strong><span>MCP · security · context engineering · assessment</span></li><li><strong>UiPath Academy — Automation Business Analyst Associate Training</strong><span>process discovery · BPMN · UAT · deployment</span></li><li><strong>FIRJAN SENAI — AI Agents & Automations</strong><span>40h</span></li></ol></div>
    </section>'''
