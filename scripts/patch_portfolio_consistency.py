...
for rel, lang in (("index.html", "pt"), ("en/index.html", "en")):
    ...
    if lang == "pt":
        ...
        new_ld = '"knowsAbout":["n8n","Automação de processos","Mapeamento de processos AS-IS/TO-BE","Levantamento de requisitos","Regras de negócio","APIs REST","Webhooks","JSON","OAuth 2.0","Python","FastAPI","PostgreSQL","SQLite FTS5","Docker","Linux","IA generativa","RAG","LangChain","Human-in-the-loop","Rastreabilidade","Auditoria","GitHub Actions","AWS","PySpark"]'
    else:
        text = text.replace(
        ...
        new_ld = '"knowsAbout":["n8n","Process automation","Process mapping AS-IS/TO-BE","Requirements discovery","Business rules","REST APIs","Webhooks","JSON","OAuth 2.0","Python","FastAPI","PostgreSQL","SQLite FTS5","Docker","Linux","Generative AI","RAG","LangChain","Human-in-the-loop","Traceability","Auditing","GitHub Actions","AWS","PySpark"]'
