...
def update_skills(relative: str, english: bool) -> None:
    ...
    pairs = [
        ...
        ("Mala Direta, Produção Operacional, Proposta Comercial, HelpDesk and the Operational Procurement Catalog demonstrate scale, adoption, deployment and business routines.", "Mala Direta, Produção Operacional, Proposta Comercial, HelpDesk and the Operational Procurement Catalog demonstrate recurring use, adoption, deployment, training and business routines."),
        ("Mala Direta, Produção Operacional, Proposta Comercial, HelpDesk e Catálogo Operacional de Compras comprovam escala, adoção, implantação e rotinas empresariais.", "Mala Direta, Produção Operacional, Proposta Comercial, HelpDesk e Catálogo Operacional de Compras comprovam uso recorrente, adoção, implantação, treinamento e rotinas empresariais."),
