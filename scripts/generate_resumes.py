...
PT = {
    ...
    "summary": (
        ...
        "Administro uma instância n8n self-hosted com 10 mil+ execuções de workflows em produção e desenvolvo soluções "
        "com Python, FastAPI, APIs REST, bancos de dados e IA generativa, do levantamento à implantação, treinamento e sustentação."
    ),
    ...
    "skills": [
        ...
        "<b>IA e integrações:</b> OpenAI, Gemini, Ollama e OpenRouter, APIs de LLM, engenharia de prompts, recuperação de contexto/grounding, JSON Schema, pipelines multiestágio, IA multimodal e geração de mídia; APIs REST, webhooks, OAuth 2.0, SMTP/IMAP e Meta Graph API.",
    ...
    "vesper_points": [
        "Administro uma instância n8n self-hosted em Windows/Docker com 10 mil+ execuções de workflows em produção, integrando APIs, webhooks, PostgreSQL e SMTP com logs, retries, alertas, backups e auditoria.",
    ...
    "compasso_role": "Estagiário de TI/Dados | Programa de Bolsas em Engenharia de Dados",
    "compasso_point": (
        "Concluí 10 sprints práticas e construí um pipeline com Python, SQL, Docker e AWS: ingestão CSV/API TMDB, S3, Lambda/boto3, "
    ...
    "projects": [
        ...
        "<b>Postagem Redes:</b> 3 workflows n8n e 58 nós no fluxo de ações; Meta Graph API, OpenAI, Gemini e Ollama, aprovação humana e idempotência, com Facebook e Instagram exercitados em teste.",
...
EN = {
    ...
    "summary": (
        "AI Automation and Integrations Analyst with end-to-end experience in internal processes and systems. I administer a self-hosted "
        "n8n environment with 10,000+ workflow executions in production and build solutions with Python, FastAPI, REST APIs, databases and "
        "generative AI, from discovery through deployment, training and support."
    ),
    ...
    "skills": [
        ...
        "<b>AI and integrations:</b> OpenAI, Gemini, Ollama and OpenRouter, LLM APIs, prompt engineering, context retrieval/grounding, JSON Schema, multi-stage pipelines, multimodal AI and media generation; REST APIs, webhooks, OAuth 2.0, SMTP/IMAP and Meta Graph API.",
    ...
    "vesper_org": "GRUPO VESPER",
    "vesper_company": "Vesper Equipamentos EX and Vent Rio Equipamentos",
    ...
    "vesper_points": [
        "Administer a self-hosted n8n environment on Windows/Docker with 10,000+ workflow executions in production, integrating APIs, webhooks, PostgreSQL and SMTP with logs, retries, alerts, backups and auditing.",
    ...
    "compasso_org": "COMPASS UOL",
    "compasso_date": "10/2024 - 03/2025",
    "compasso_role": "Data Engineering Intern | Scholarship Program",
    "compasso_point": (
    ...
    "projects": [
        ...
        "<b>Postagem Redes:</b> 3 n8n workflows and 58 nodes in the actions flow; Meta Graph API, OpenAI, Gemini and Ollama, human approval and idempotency, with Facebook and Instagram exercised in testing.",
    ...
    "education": [
        "<b>Technology Degree (Tecnólogo) in Systems Analysis and Development - UNISUAM</b> | expected completion: Dec. 2026",
    ...
    "certs": (
        ...
        "Process Automation with RPA - ENAP (25h); Process Mapping and Automation - ENAP (20h)."
    ),
...
class LayoutAudit:
    ...
    def add(self, name: str, top: float, bottom: float) -> None:
        if top < bottom:
            raise RuntimeError(f"invalid block geometry: {name}")
        if self.blocks:
            previous = self.blocks[-1]
            gap = previous.bottom - top
            if gap < -0.25:
                raise RuntimeError(f"layout overlap: {previous.name} and {name}, overlap={-gap:.1f}pt")
...
def generate(data: dict[str, object]) -> Path:
    ...
    canvas.setKeywords(
        "automation, process automation, n8n, low-code, process mapping, AS-IS, TO-BE, generative AI, AI agents, multimodal AI, media generation, systems integration, REST APIs, webhooks, Python, JavaScript, TypeScript, FastAPI, PostgreSQL, SQLite FTS5, Docker, AWS, data engineering, PySpark, RLS, outbox, Action Envelope"
    )
    ...
    project = ParagraphStyle("project", parent=base, fontSize=8.4, leading=10.15, leftIndent=13, firstLineIndent=-9)
    compact = ParagraphStyle("compact", parent=base, fontSize=8.7, leading=10.7)
