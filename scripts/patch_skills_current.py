...
('Mapeio processos AS-IS/TO-BE, requisitos, regras de negócio, exceções e aprovações. No n8n, desenvolvo interfaces, webhooks, filas, agendamentos, persistência, tratamento de falhas e integrações, sem retirar a supervisão humana quando a decisão precisa ser revisada.','Faço mapeamento de processos com BPMN e AS-IS/TO-BE, levanto requisitos, regras de negócio, exceções, aprovações e necessidades de rastreabilidade. Meu núcleo é n8n self-hosted, mas também uso Power Automate, Make e Zapier quando o contexto pede outro ecossistema, além de CRM em rotinas de integração e automação. Também explico e oriento outras pessoas sobre essas ferramentas quando necessário.'),
('n8n self-hosted · low-code/no-code · AS-IS/TO-BE · requisitos · regras de negócio · workflows · aprovação humana · documentação','n8n self-hosted · Power Automate · Make · Zapier · CRM · BPMN · AS-IS/TO-BE · requisitos · regras de negócio · rastreabilidade · aprovação humana · documentação'),
('Utilizo OpenAI, Gemini, Ollama, OpenRouter e Codex em criação assistida, análise, classificação e recuperação de contexto. Em projetos de mídia, trabalho com texto, imagem e áudio, sempre com revisão humana e fallbacks quando a integração permite.','Utilizo OpenAI, Gemini e Ollama por APIs de LLM, engenharia de prompts, respostas estruturadas e recuperação de contexto. No Postagem Redes, implementei RAG/grounding com LangChain, Supabase e n8n/Docker para reduzir respostas sem base nas informações da empresa. Em estudos e protótipos, também pratiquei MCP, LangGraph e CrewAI para explorar ferramentas de agentes e orquestração; não apresento essas ferramentas no mesmo nível do meu núcleo em n8n, Python e APIs.'),
('OpenAI · Gemini · Ollama · OpenRouter · Codex · APIs de LLM · prompts · grounding · JSON Schema · IA multimodal','OpenAI · Gemini · Ollama · APIs de LLM · prompts · RAG/grounding · LangChain · human-in-the-loop · MCP/LangGraph/CrewAI (uso contextual)'),
...
('I map AS-IS/TO-BE processes, requirements, business rules, exceptions and approvals. In n8n, I build interfaces, webhooks, queues, schedules, persistence, failure handling and integrations while preserving human supervision when a decision must be reviewed.','I map processes with BPMN and AS-IS/TO-BE, gather requirements, business rules, exceptions, approvals and traceability needs. My core platform is self-hosted n8n, but I also use Power Automate, Make and Zapier when another ecosystem fits the context, plus CRM in integration and automation routines. I also explain and guide others on these tools when needed.'),
('self-hosted n8n · low-code/no-code · AS-IS/TO-BE · requirements · business rules · workflows · human approval · documentation','self-hosted n8n · Power Automate · Make · Zapier · CRM · BPMN · AS-IS/TO-BE · requirements · business rules · traceability · human approval · documentation'),
('I use OpenAI, Gemini, Ollama, OpenRouter and Codex for assisted creation, analysis, classification and context retrieval. In media projects, I work with text, image and audio, with human review and fallbacks when the integration supports them.','I use OpenAI, Gemini and Ollama through LLM APIs, prompt engineering, structured outputs and context retrieval. In Postagem Redes, I implemented RAG/grounding with LangChain, Supabase and n8n/Docker to reduce answers that are not grounded in company information. In studies and prototypes, I have also practiced MCP, LangGraph and CrewAI to explore agent tooling and orchestration; I do not present them at the same experience level as my core work with n8n, Python and APIs.'),
('OpenAI · Gemini · Ollama · OpenRouter · Codex · LLM APIs · prompts · grounding · JSON Schema · multimodal AI','OpenAI · Gemini · Ollama · LLM APIs · prompts · RAG/grounding · LangChain · human-in-the-loop · MCP/LangGraph/CrewAI (contextual use)'),
('I build with Python, JavaScript/TypeScript, Node.js/Express and FastAPI. I use SQL, PostgreSQL, SQLite and FTS5, along with Docker and GitHub Actions. During the Compass Program, I worked with S3, Lambda, Glue/PySpark, Parquet, Athena and QuickSight.','I build with Python, JavaScript/TypeScript and FastAPI. I use SQL, PostgreSQL, SQLite/FTS5, Docker, Linux and Git/GitHub Actions. During the Compass Program, I worked with ETL/Data Lake, S3, Lambda, Glue/PySpark, Parquet, Athena and QuickSight.'),
('Python · JavaScript/TypeScript · Node.js/Express · FastAPI · SQL · PostgreSQL · SQLite FTS5 · Docker · AWS · PySpark · Git/GitHub Actions','Python · JavaScript/TypeScript · FastAPI · SQL · PostgreSQL · SQLite FTS5 · Docker · Linux · AWS/PySpark · Git/GitHub Actions'),
