...
PT_REPLACEMENTS = {
    ...
    "Competências comprovadas de Maycon Ferreira": "Competências e experiência prática de Maycon Ferreira",
    "Competências comprovadas | Maycon Ferreira": "Competências e experiência prática | Maycon Ferreira",
    "Mala Direta, Produção Operacional, Vesper Propostas, HelpDesk e Catálogo Operacional de Compras comprovam uso recorrente, adoção, implantação, treinamento e rotinas empresariais.": "Apliquei essas práticas na Mala Direta, no Produção Operacional, no Vesper Propostas, no HelpDesk e no Catálogo Operacional de Compras, todos ligados a rotinas reais de trabalho.",
    "Mala Direta, Produção Operacional, Vesper Propostas, HelpDesk e Catálogo Operacional de Compras comprovam escala, adoção, implantação e rotinas empresariais.": "Apliquei essas práticas na Mala Direta, no Produção Operacional, no Vesper Propostas, no HelpDesk e no Catálogo Operacional de Compras, todos ligados a rotinas reais de trabalho.",
    "Postagem Redes demonstra IA generativa e APIs externas. Portal demonstra fundação multiempresa e governança, com Procurement implementado em sandbox e revalidação do head atual antes do piloto.": "No Postagem Redes, trabalhei com IA generativa e APIs externas. No Portal, estou desenvolvendo uma fundação multiempresa com governança; Procurement foi exercitado em sandbox e o head atual passa por revalidação antes do piloto.",
    "Postagem Redes demonstra IA e APIs externas. Portal, ainda em desenvolvimento, demonstra fundação multiempresa, governança, Procurement em sandbox e arquitetura full-stack sem ser apresentado como produção.": "No Postagem Redes, trabalhei com IA e APIs externas. No Portal, desenvolvo uma fundação multiempresa com governança e arquitetura full-stack, ainda sem apresentá-la como produção.",
...
EN_REPLACEMENTS = {
    ...
    "Automation, AI, data and governance backed by evidence.": "Automation, AI, data and governance applied in real projects.",
    ...
    "The skills below are tied to production systems, internal use, pilots, reference architectures and private prototypes. Delivery status is declared so implementation, testing, sandbox, pilot and production are not treated as synonyms.": "Below are technologies and practices I use across internal systems, automations, public projects and products in development. Each case states its current status and limits.",
    "OPERATIONAL EVIDENCE": "WHERE I USE IT IN PRACTICE",
    "BREADTH EVIDENCE": "OTHER CONTEXTS",
    "Main evidence:": "A few results:",
    "Key evidence:": "A few results:",
    ...
    "Evidence-based skills in process automation": "Skills and practical experience in process automation",
    "Evidence-based skills | Maycon Ferreira": "Skills and practical experience | Maycon Ferreira",
    "Mala Direta, Produção Operacional, Vesper Propostas, HelpDesk and the Operational Procurement Catalog demonstrate recurring use, adoption, deployment, training and business routines.": "I applied these practices in Mala Direta, Produção Operacional, Vesper Propostas, HelpDesk and the Operational Procurement Catalog, all connected to real work routines.",
    "Mala Direta, Produção Operacional, Vesper Propostas, HelpDesk and the Operational Procurement Catalog demonstrate scale, adoption, deployment and business routines.": "I applied these practices in Mala Direta, Produção Operacional, Vesper Propostas, HelpDesk and the Operational Procurement Catalog, all connected to real work routines.",
    "Postagem Redes demonstrates generative AI and external APIs. Portal demonstrates multi-tenant foundations and governance, with Procurement implemented in sandbox and current-head revalidation before a pilot.": "In Postagem Redes, I worked with generative AI and external APIs. In Portal, I am building a multi-tenant foundation with governance; Procurement was exercised in sandbox and the current head is being revalidated before a pilot.",
    "Postagem Redes demonstrates AI and external APIs. Portal, still in development, demonstrates multi-tenant foundations, governance, sandbox Procurement and full-stack architecture without being presented as production.": "In Postagem Redes, I worked with AI and external APIs. In Portal, I am building a multi-tenant foundation with governance and full-stack architecture, without presenting it as production.",
