...
COMMON = {
    ...
    "Cada indicador pertence ao sistema ou ambiente que o sustenta. Valores operacionais podem evoluir com o uso.": "Cada resultado aparece com o projeto e o contexto em que foi medido.",
    "Cada indicador é contextualizado no case correspondente. Valores operacionais podem evoluir com o uso.": "Cada resultado aparece com o projeto e o contexto em que foi medido.",
    ...
    "Each indicator belongs to the system or environment that supports it. Operational values may evolve with usage.": "Each result is shown with its project and measurement context.",
    "Each indicator is contextualized in its corresponding case. Operational values may evolve with usage.": "Each result is shown with its project and measurement context.",
